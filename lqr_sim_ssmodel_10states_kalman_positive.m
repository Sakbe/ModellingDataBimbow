% $Author: Il_Ciancio $	$Date: 2019/06/11 15:43:26 $
% $Author: Alessandro Cianciulli, al.cianciulli@studenti.unina.it $
...
%% POSITIVE model without D
states = 10;
data = load('ss1_10states.mat');
ss_model = data.ss1_10states;
...
sim('lqr_ssmodel_10states_kalmanretro_positive.slx')